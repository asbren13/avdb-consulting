...
export default function Footer({ lightFooter = false, showExpanded = false, redFooter = false }) {
  return (
    <footer className={classNames('footer-section flex flex-col items-center w-full', { light: lightFooter, sand: !lightFooter && !redFooter, red: redFooter })}>
      ...
      {showExpanded && (
      	<div className="flex items-end justify-between bg-red w-full mt-8 px-14 py-16 text-secondary">
      	  <div className="flex items-center h-full">
              ...
              <div className="text-lg font-bold pt-2">Interested in reimagining your marketing strategy in a post COVID-19 world, or just chatting with a like-minded hospitality professional?</div>
